...
public class CommandTestUtil {
    ...
    public static final String VALID_OPENING_HOURS = "0000 - 2359";
    ...
    public static final String INVALID_HOUR_OPENING_HOURS_DESC = " " + PREFIX_OPENING_HOURS + "0000 - 2500";
    public static final String INVALID_MINUTE_OPENING_HOURS_DESC = " " + PREFIX_OPENING_HOURS + "2200 - 2260";
    public static final String INVALID_FORMAT_OPENING_HOURS_DESC = " " + PREFIX_OPENING_HOURS + "1400-1600";
